...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["email"]))) {
        ...
        $email_err = "Please enter a valid email. Ex: epicure@email.com";
    } else {
...
<body>
    ...
    <div class="register_wrapper"> <!-- Updated class name -->
        <a class="nav-link" href="../home/home.php#hero"> <h1 class="text-center" style="font-family:Copperplate; color:white;"> EPICURE'S</h1><span class="sr-only"></span></a><br>
